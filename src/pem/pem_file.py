...
if __name__ == '__main__':
    ...
    print(f"Time to rotate with old method: {time.time() - t1}")

    t2 = time.time()
    file, inel_stations = file.prep_rotation()
    file.rotate2(method='mag', soa=0)
    print(f"Time to rotate with new method: {time.time() - t2}")
    #
