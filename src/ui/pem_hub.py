...
class Ui_PEMHub(object):
    def setupUi(self, PEMHub):
        ...
        sizePolicy3.setHeightForWidth(self.middle_frame.sizePolicy().hasHeightForWidth())
        self.middle_frame.setSizePolicy(sizePolicy3)
        ...
        sizePolicy6.setHeightForWidth(self.directory_frame.sizePolicy().hasHeightForWidth())
        self.directory_frame.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.project_dir_frame.sizePolicy().hasHeightForWidth())
        self.project_dir_frame.setSizePolicy(sizePolicy7)
