...
class Ui_PEMHub(object):
    def setupUi(self, PEMHub):
        ...
        size_policy.setHeightForWidth(self.project_tree.sizePolicy().hasHeightForWidth())
        self.project_tree.setSizePolicy(size_policy)
        ...
        size_policy.setHeightForWidth(self.pem_list.sizePolicy().hasHeightForWidth())
        self.pem_list.setSizePolicy(size_policy)
...
#if QT_CONFIG(tooltip)
        self.actionAdd_Mapbox_Token.setToolTip(QCoreApplication.translate("PEMHub", u"Mapbox tokens are used in by Tools > Tilemap.", None))
#endif // QT_CONFIG(tooltip)
