...
class Ui_PEMHub(object):
    def setupUi(self, PEMHub):
        ...
        icon24 = QIcon()
        icon24.addFile(u"icons/refresh.png", QSize(), QIcon.Normal, QIcon.Off)
        self.refresh_pem_list_btn.setIcon(icon24)
        ...
        icon25 = QIcon()
        icon25.addFile(u"icons/filter.png", QSize(), QIcon.Normal, QIcon.Off)
        self.filter_pem_list_btn.setIcon(icon25)
        ...
        icon26 = QIcon()
        icon26.addFile(u"icons/add_square.png", QSize(), QIcon.Normal, QIcon.Off)
        self.add_pem_btn.setIcon(icon26)
        ...
        icon27 = QIcon()
        icon27.addFile(u"icons/remove.png", QSize(), QIcon.Normal, QIcon.Off)
        self.remove_pem_btn.setIcon(icon27)
        ...
        self.refresh_gps_list_btn.setIcon(icon24)
        ...
        self.filter_gps_list_btn.setIcon(icon25)
        ...
        self.add_gps_btn.setIcon(icon26)
        ...
        self.remove_gps_btn.setIcon(icon27)
        ...
        icon28 = QIcon()
        icon28.addFile(u"icons/export.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuExport_Files.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u"icons/reverse.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuReverse_Polarity.setIcon(icon29)
