...
class Ui_PEMInfoWidget(object):
    def setupUi(self, PEMInfoWidget):
        ...
        sizePolicy5.setHeightForWidth(self.shiftStationGPSSpinbox.sizePolicy().hasHeightForWidth())
        self.shiftStationGPSSpinbox.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.edit_line_btn.sizePolicy().hasHeightForWidth())
        self.edit_line_btn.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.lcdDistance.sizePolicy().hasHeightForWidth())
        self.lcdDistance.setSizePolicy(sizePolicy6)
        ...
        sizePolicy5.setHeightForWidth(self.stations_from_data_btn.sizePolicy().hasHeightForWidth())
        self.stations_from_data_btn.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.cullStationGPSButton.sizePolicy().hasHeightForWidth())
        self.cullStationGPSButton.setSizePolicy(sizePolicy5)
